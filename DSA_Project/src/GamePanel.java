...
public class GamePanel extends JPanel {
    ...
    private GameController gameController = new HarderGameController();
    ...
    public GamePanel(String playerName, UnderOverDiceGame mainFrame) {
        ...
        payoutPanel.add(new JLabel("Under 10: x2") {{ setForeground(Color.WHITE);setFont(new Font("Arial", Font.BOLD, 15)); }});
        payoutPanel.add(new JLabel("Equal 10: x4") {{ setForeground(Color.WHITE);setFont(new Font("Arial", Font.BOLD, 15)); }});
        payoutPanel.add(new JLabel("Over 10: x1.8") {{ setForeground(Color.WHITE);setFont(new Font("Arial", Font.BOLD, 15)); }});
        ...
        balanceAndPayoutPanel.add(Box.createVerticalStrut(5));
        ...
        controlPanel.add(new JLabel("Choice:") {{ setForeground(Color.WHITE); }});
