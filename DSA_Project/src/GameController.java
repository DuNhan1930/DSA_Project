...
public class GameController {
    ...
    public RoundResult playRound(int bet, String choice) {
        ...
        if (sum < 10 && choice.equals("Under")) {
            ...
            win = true;
        } else if (sum == 10 && choice.equals("Equal")) { // NEW logic for equal!
    ...
    // Example of a sorting algorithm (Merge Sort) to sort round history by bet amount
    ...
    // Helper class to return detailed round results
